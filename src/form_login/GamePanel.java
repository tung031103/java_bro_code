...
public class GamePanel extends JPanel implements Runnable {
    ...
    public void checkCollision() {
        ...
        if (ball.y <= 0) {
            ball.setYDirection(-ball.yVelcocity);
        }
        ...
        if (ball.intersects(paddle1)) {
            ball.xVelcocity = Math.abs(ball.xVelcocity);
            ball.xVelcocity++; // optional for more difficulty
            if (ball.yVelcocity > 0)
                ball.yVelcocity++; // optional for more difficulty
            else
                ball.yVelcocity--;
            ball.setXDirection(ball.xVelcocity);
            ball.setYDirection(ball.yVelcocity);
